...
#define HIMAX_DRIVER_VER "1.2.2.56_LGE_MH4_03"
...
struct himax_ic_data {
	...
	int lge_fw_ver_majr1;
	int lge_fw_ver_majr2;
	int lge_fw_ver_minor;
	int		HX_RX_NUM;
	int		HX_TX_NUM;
	int		HX_BT_NUM;
	int		HX_X_RES;
...
#define GEST_PTLG_HDR_LEN	(48)
#define GEST_PTLG_HDR_ID1	(0xCC)
#define GEST_PTLG_HDR_ID2	(0x44)
#define GEST_PT_MAX_NUM 	(128)
#define GEST_PT_STATE_FT	(44)
#define GEST_PT_STATE_FR	(45)
#define GEST_PT_COUNT		(50)
...
extern int hx83102d_report_data_init(void);
extern uint8_t hx83102d_int_gpio_read(int pinnum);
extern void hx83102d_burst_enable(struct device *dev, uint8_t auto_add_4_byte);
extern int hx83102d_register_read(struct device *dev, uint32_t addr, uint32_t read_length, uint8_t *read_data, uint8_t addr_len);
extern int hx83102d_register_write(struct device *dev, uint32_t addr, uint32_t write_length, uint8_t *read_data, uint8_t addr_len);
extern void hx83102d_interface_on(struct device *dev);
extern void hx83102d_sense_on(struct device *dev, uint8_t FlashMode);
extern bool hx83102d_sense_off(struct device *dev, bool check_en);
extern void hx83102d_set_SMWP_enable(struct device *dev, uint8_t SMWP_enable);
extern void hx83102d_read_FW_ver(struct device *dev);
extern bool hx83102d_calculateChecksum(struct device *dev);
extern int hx83102d_assign_sorting_mode(struct device *dev, uint8_t *tmp_data);
extern int hx83102d_fts_ctpm_fw_upgrade_with_sys_fs_64k(struct device *dev, unsigned char *fw, int len);
extern void hx83102d_ic_reset(struct device *dev, uint8_t loadconfig, uint8_t int_off);
extern void hx83102d_touch_information(struct device *dev);
#endif
