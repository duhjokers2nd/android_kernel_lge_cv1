...
int mdss_dsi_panel_power_on(struct mdss_panel_data *pdata)
{
	...
	switch (lge_get_panel_type()) {
		...
		case CV1_TOVIS_TD4100:
			ret = tovis_td4100_mdss_dsi_panel_power_on(pdata);
			break;
		default:
			break;
	}
...
int mdss_dsi_panel_power_off(struct mdss_panel_data *pdata)
{
	...
	switch (lge_get_panel_type()) {
		...
		case CV1_TCL_FT8006M:
			...
			break;
		case CV1_TOVIS_TD4100:
			ret = tovis_td4100_mdss_dsi_panel_power_off(pdata);
			break;
		default:
			break;
	}
...
int mdss_dsi_panel_reset(struct mdss_panel_data *pdata, int enable)
{
	...
	switch (lge_get_panel_type()) {
		...
		case CV1_TCL_FT8006M:
			...
			break;
		case CV1_TOVIS_TD4100:
			rc = tovis_td4100_mdss_dsi_panel_reset(pdata, enable);
			break;
		default:
			break;
	}
...
int lge_mdss_dsi_pre_event_handler(struct mdss_panel_data *pdata, int event, void *arg)
{
	...
	switch (lge_get_panel_type()) {
		case CV1_TOVIS_TD4100:
			rc = tovis_td4100_mdss_dsi_pre_event_handler(pdata, event, arg);
			break;
		default:
			break;
	}
...
int lge_mdss_dsi_post_event_handler(struct mdss_panel_data *pdata, int event, void *arg)
{
	...
	switch (lge_get_panel_type()) {
		case CV1_LGD_LG4894A:
			...
			break;
		case CV1_TOVIS_TD4100:
			rc = tovis_td4100_mdss_dsi_post_event_handler(pdata, event, arg);
			break;
		default:
			break;
	}
...
void mdss_dsi_ctrl_shutdown(struct platform_device *pdev)
{
	switch (lge_get_panel_type()) {
		...
		case CV1_TCL_FT8006M:
			...
			break;
		case CV1_TOVIS_TD4100:
			tovis_td4100_mdss_dsi_ctrl_shutdown(pdev);
			break;
		default:
			break;
	}
