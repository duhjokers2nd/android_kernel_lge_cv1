...
#include <asm/gpio.h> //Mesin added for front camera flash
#undef CDBG
	...
	struct msm_flash_cfg_data_t *flash_data)
{
	...
	mdelay(10); //LGE_CHANGE, add delay for torch flash on/off, gayoung85.lee@lge.com
	CDBG("Exit\n");
...
#define front_flash  9 //Mesin added for  front flash MH420180905 +
	...
	struct msm_flash_cfg_data_t *flash_data)
{
	...
	// the number 9 means number of rising edges, 87.5mA
	for (raise_num = 0;raise_num < 9;raise_num++)
	{
...
//Mesin added for  front flash MH420180905 -
