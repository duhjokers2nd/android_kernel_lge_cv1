...
static bool vdd_always_on = false;
	...
	|| defined(CONFIG_MACH_MSM8917_LV7_CCT_US_VZW) || defined(CONFIG_MACH_MSM8917_LV7_CRK_US) || defined(CONFIG_MACH_MSM8917_LV7_GLOBAL_CA) || defined(CONFIG_MACH_MSM8917_LV7_LAO_COM)
...
char *rev_str[] = {"rev_0", "rev_02", "rev_a", "rev_b", "rev_c", "rev_d",
	"rev_10", "rev_11", "rev_12", "reserved"};
#elif defined(CONFIG_MACH_SDM450_CV7A_LAO_COM) || defined(CONFIG_MACH_SDM450_CV7A_KR) || defined(CONFIG_MACH_SDM450_CV7A_LAO_COM_NONAB) || defined(CONFIG_MACH_SDM450_CV7A_LGU_LDR) || defined(CONFIG_MACH_SDM450_CV7A_SB_JP) || defined(CONFIG_MACH_SDM450_CV7A_RMM_JP)
char *rev_str[] = {"rev_0", "rev_01", "rev_02", "rev_a", "rev_b", "rev_c", "rev_d", "rev_e",
	"rev_10", "rev_11", "reserved"};
	...
	|| defined(CONFIG_MACH_SDM450_CV5A_SKT_KR) || defined(CONFIG_MACH_SDM450_CV5A_TMO_US_SPROUT) || defined(CONFIG_MACH_SDM450_CV5A_LGU_LDU) \
        || defined(CONFIG_MACH_SDM450_MH4_LAO_COM) || defined(CONFIG_MACH_SDM450_MH4_LAO_COM_NONAB)
char *rev_str[] = {"rev_0", "rev_01", "rev_02", "rev_a", "rev_a_1", "rev_b", "rev_b_1", "rev_b_2", "rev_c",
	"rev_10", "rev_11", "reserved"};
...
char *rev_str[] = {"rev_a", "rev_a_2", "rev_a_3", "rev_b", "rev_c",
	"rev_10", "rev_11", "reserved"};
#elif defined(CONFIG_MACH_MSM8940_SF3_MPCS_US) || defined(CONFIG_MACH_MSM8940_SF3_TMO_US) || defined(CONFIG_MACH_MSM8940_TF8_TMO_US) || defined(CONFIG_MACH_MSM8940_SF3_GLOBAL_CA) || defined(CONFIG_MACH_MSM8917_CV1_LAO_COM) || defined(CONFIG_MACH_MSM8917_CV1_VZW) || defined(CONFIG_MACH_MSM8917_CV1_ATT_US) || defined(CONFIG_MACH_MSM8917_CV1_CRK_US) || defined(CONFIG_MACH_MSM8917_CV1_KDDI_JP) || defined(CONFIG_MACH_MSM8917_CV1S_LAO_COM)
char *rev_str[] = {"rev_0", "rev_a", "rev_a_2", "rev_b", "rev_c", "rev_d",
        "rev_10", "rev_11", "reserved"};
#elif defined(CONFIG_MACH_MSM8917_B6_JCM_JP) || defined(CONFIG_MACH_MSM8917_B6_LGU_KR) || defined(CONFIG_MACH_MSM8917_B6_LAO_COM) || defined(CONFIG_MACH_MSM8917_B6_OPEN_SK)
...
struct panel_lookup_entry panel_lookup_table[] = {
	...
	{"tovis_td4100_hd_video", LV7V_TOVIS},
	...
	{"lgd_incell_sw49107_hd_command", LGD_INCELL_SW49107_HD},
	{"lgd_incell_sw49107_fhd_command", LGD_INCELL_SW49107},
	{"tovis_incell_sw49107_hd_command", TOVIS_INCELL_SW49107_HD},
	{"tovis_incell_sw49107_fhd_command", TOVIS_INCELL_SW49107},
	{"tianma_ft8006m_hd_video",CV1_TIANMA_FT8006M},
	{"lgd_lg4894a_hd_video", CV1_LGD_LG4894A},
	{"tcl_ft8006m_hd_video",CV1_TCL_FT8006M},
	{"cv1_tovis_td4100_hd_video",CV1_TOVIS_TD4100},
	{"cv3_lgd_lg4894_hd_video",CV3_LGD},
	{"cv3_tovis_lg4894_hd_video",CV3_TOVIS},
	{"boe_incell_ili9881h_hd_video",BOE_INCELL_ILI9881H},
	{"csot_incell_ft8736_hd_video",CSOT_INCELL_FT8736},
	{"boe_incell_hx83102d_hd_video",BOE_INCELL_HX83102D},
};
...
static bool panel_status_vcom_mtp = true;
static int __init lge_check_lcm_vcom_mtp(char *s)
{
	if(!strcmp(s, "no")) {
		panel_status_vcom_mtp = false;
	}
	pr_info("%s : LCM VCOM MTP [%s]\n",__func__, panel_status_vcom_mtp ? "yes" : "no");
	return 0;
}
__setup("lge.vcomMTP=", lge_check_lcm_vcom_mtp);

bool lge_get_lcm_vcom_mtp(void)
{
	return panel_status_vcom_mtp;
}
#endif
...
int att_code_mode = 0;
static int __init lge_att_code_mode_init(char *s)
{
	if(strncmp(s, "1", 1) == 0)
		att_code_mode=1;

	pr_info("[LAOP] kernel bootmode check for att_code_mode : %d\n", att_code_mode);

	return 0;
}
__setup("lge.att_code=", lge_att_code_mode_init);

int lge_get_board_att(void)
{
	return att_code_mode;
}
#endif
